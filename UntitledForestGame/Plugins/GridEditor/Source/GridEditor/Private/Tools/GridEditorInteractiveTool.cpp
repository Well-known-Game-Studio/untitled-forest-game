...
#include "GridEditorInteractiveTool.h"
...
UInteractiveTool* UGridEditorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UGridEditorInteractiveTool* NewTool = NewObject<UGridEditorInteractiveTool>(SceneState.ToolManager);
...
UGridEditorInteractiveToolProperties::UGridEditorInteractiveToolProperties()
{
...
void UGridEditorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UGridEditorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UGridEditorInteractiveToolProperties>(this, "Measurement");
...
void UGridEditorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UGridEditorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UGridEditorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UGridEditorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UGridEditorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UGridEditorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UGridEditorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UGridEditorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UGridEditorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
