...
#include "GridEditorInteractiveTool.generated.h"


/**
 * Builder for UGridEditorInteractiveTool
 */
UCLASS()
class GRIDEDITOR_API UGridEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UGridEditorInteractiveTool
 */
UCLASS(Transient)
class GRIDEDITOR_API UGridEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UGridEditorInteractiveToolProperties();
...
/**
 * UGridEditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class GRIDEDITOR_API UGridEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UGridEditorInteractiveToolProperties> Properties;
