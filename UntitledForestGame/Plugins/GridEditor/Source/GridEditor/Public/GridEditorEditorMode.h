...
#include "GridEditorEditorMode.generated.h"
 ...
 */
UCLASS()
class UGridEditorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_GridEditorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UGridEditorEditorMode();
	virtual ~UGridEditorEditorMode();
